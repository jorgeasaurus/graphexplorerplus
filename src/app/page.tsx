    ...
    <div className="relative min-h-screen overflow-hidden bg-bg-deep font-sans text-text-primary">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 pb-8 pt-24 text-center sm:pt-32 md:pt-40">
        ...
        >
          <Link
            href="/explorer"
            className="inline-flex items-center gap-2 rounded-xl bg-accent px-8 py-3.5 text-base font-semibold text-bg-deep shadow-[0_0_32px_rgba(0,212,170,0.25)] transition hover:bg-accent-hover hover:shadow-[0_0_48px_rgba(0,212,170,0.35)]"
          >
            Launch Explorer
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-border-default px-8 py-3.5 text-base font-medium text-text-secondary transition hover:border-border-strong hover:text-text-primary"
          >
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 py-12 sm:py-20">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, i) => (
            <div
              key={feature.title}
              className="animate-fade-up group rounded-xl border border-border-subtle bg-bg-surface p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-border-default hover:shadow-lg hover:shadow-accent/5"
