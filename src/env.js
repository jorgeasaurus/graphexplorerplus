...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_MSAL_CLIENT_ID_USGOV: z.string().min(1).optional(),
    NEXT_PUBLIC_MSAL_CLIENT_ID_USGOVDOD: z.string().min(1).optional(),
    NEXT_PUBLIC_MSAL_CLIENT_ID_GERMANY: z.string().min(1).optional(),
    NEXT_PUBLIC_MSAL_CLIENT_ID_CHINA: z.string().min(1).optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_MSAL_CLIENT_ID_USGOV: process.env.NEXT_PUBLIC_MSAL_CLIENT_ID_USGOV,
    NEXT_PUBLIC_MSAL_CLIENT_ID_USGOVDOD: process.env.NEXT_PUBLIC_MSAL_CLIENT_ID_USGOVDOD,
    NEXT_PUBLIC_MSAL_CLIENT_ID_GERMANY: process.env.NEXT_PUBLIC_MSAL_CLIENT_ID_GERMANY,
    NEXT_PUBLIC_MSAL_CLIENT_ID_CHINA: process.env.NEXT_PUBLIC_MSAL_CLIENT_ID_CHINA,
